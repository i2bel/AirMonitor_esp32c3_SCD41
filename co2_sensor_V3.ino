...
void saveHistoryToFS() {
  // CO2
  HistoryState co2State = {co2Index, co2Count};
  ...
  // Температура
  HistoryState tempState = {tempIndex, tempCount};
  ...
  // Влажность
  HistoryState humState = {humIndex, humCount};
...
<head>
    ...
    <link rel="icon" type="image/png" href="data:image/png;base64,">
    <style>
        * {
            margin: 0;
            padding: 0;
